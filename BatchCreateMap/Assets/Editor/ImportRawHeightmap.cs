...
public class ImportRawHeightmap : TerrainWizard
{
    public enum Depth
    {
        Bit8 = 1,
    ...
    public ImportRawHeightmap.Depth m_Depth = ImportRawHeightmap.Depth.Bit8;
    ...
    {
        base.minSize = new Vector2(400f, 250f);
    }
    ...
    private void ReadRaw(string path)
    {
        ...
        else
        {
            ...
            for (int k = 0; k < heightmapHeight; k++)
            {
                ...
                {
                    int num7 = Mathf.Clamp(l, 0, this.m_Width - 1) + Mathf.Clamp(k, 0, this.m_Height - 1) * this.m_Width;//获取起点下标
                    byte b2 = array[num7];
    ...
    public void InitializeImportRaw(Terrain terrain, string path)
    {
